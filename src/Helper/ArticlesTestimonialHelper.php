...
namespace Joomla\Module\ArticlesTestimonial\Site\Helper;
...
/**
 * Helper for mod_articles_testimonial
 *
 * @since  1.6
 */
class ArticlesTestimonialHelper implements DatabaseAwareInterface
{
